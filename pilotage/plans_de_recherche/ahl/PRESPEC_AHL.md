...
**Status: DRAFT 2026-09-22.** Not locked. Nothing in this document has been measured
against a return. It becomes binding only when it is committed with status LOCKED and
a commit hash, and any edit after that is an amendment in `docs/PROTOCOL_FREEZE.md`.
...
`chantiers/reversal-lab/docs/RESULTS.md`.
